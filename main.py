...
class GraphTraversal:
    ...
    def make_vertex(self):  # Vertex with connection make
        ...
        self.total_circle[0] = self.make_canvas.create_oval(40, 330, 110, 370, width=3)  # Arad

        self.total_cities[0] = Label(self.make_canvas, text="Arad", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[0].place(x=60, y=340)
        # LEVEL 1

        self.total_circle[1] = self.make_canvas.create_oval(120, 260, 190, 300, width=3)  # Zerind
        self.total_cities[1] = Label(self.make_canvas, text="Zerind", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[1].place(x=135, y=270)

        self.total_circle[2] = self.make_canvas.create_oval(120, 330, 190, 370, width=3)  # Sibiu
        ...
        self.total_circle[3] = self.make_canvas.create_oval(120, 400, 190, 440, width=3)  # Temisora
        self.total_cities[3] = Label(self.make_canvas, text="Temisora", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[3].place(x=130, y=410)

        # LEVEL 2

        self.total_circle[4] = self.make_canvas.create_oval(200, 210, 270, 250, width=3)  # Zerind -> Oradia
        self.total_cities[4] = Label(self.make_canvas, text="Oradea", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[4].place(x=215, y=220)

        self.total_circle[5] = self.make_canvas.create_oval(200, 290, 270, 330, width=3)  # Sibiu -> Rimnicu
        self.total_cities[5] = Label(self.make_canvas, text="Rimnicu", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[5].place(x=210, y=300)

        self.total_circle[6] = self.make_canvas.create_oval(200, 370, 270, 410, width=3)  # Sibiu -> Fagaras
        self.total_cities[6] = Label(self.make_canvas, text="Fagaras", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[6].place(x=210, y=380)

        self.total_circle[7] = self.make_canvas.create_oval(200, 450, 270, 490, width=3)  # Temisora -> Lugoj
        ...
        self.total_circle[8] = self.make_canvas.create_oval(280, 160, 350, 200, width=3)  # Oradia -> Sibiu
        ...
        self.total_circle[9] = self.make_canvas.create_oval(280, 260, 350, 300, width=3)  # Rimnicu -> Craiova
        self.total_cities[9] = Label(self.make_canvas, text="Craiova", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[9].place(x=293, y=270)

        self.total_circle[10] = self.make_canvas.create_oval(280, 330, 350, 370, width=3)  # Rimnicu -> Pitesti
        self.total_cities[10] = Label(self.make_canvas, text="Pitesti", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[10].place(x=295, y=340)

        self.total_circle[11] = self.make_canvas.create_oval(280, 400, 350, 440, width=3)  # Fagaras -> Bucharest***
        self.total_cities[11] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[11].place(x=288, y=410)

        self.total_circle[12] = self.make_canvas.create_oval(280, 500, 350, 540, width=3)  # Lugoj -> Mehadia
        self.total_cities[12] = Label(self.make_canvas, text="Mehadia", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[12].place(x=290, y=510)

        # LEVEL 4

        self.total_circle[13] = self.make_canvas.create_oval(360, 120, 430, 160, width=3)  # Sibiu -> Fagaras
        self.total_cities[13] = Label(self.make_canvas, text="Fagaras", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[13].place(x=372, y=130)

        self.total_circle[14] = self.make_canvas.create_oval(360, 190, 430, 230, width=3)  # sibiu -> Rimnicu
        self.total_cities[14] = Label(self.make_canvas, text="Rimnicu", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[14].place(x=372, y=200)

        self.total_circle[15] = self.make_canvas.create_oval(360, 260, 430, 300, width=3)  # Craiova -> Pitesti
        self.total_cities[15] = Label(self.make_canvas, text="Pitesti", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[15].place(x=375, y=270)

        self.total_circle[16] = self.make_canvas.create_oval(360, 330, 430, 370, width=3)  # Pitesti -> Bucharest***
        self.total_cities[16] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[16].place(x=367, y=340)

        self.total_circle[17] = self.make_canvas.create_oval(360, 500, 430, 540, width=3)  # Mehadia -> Dobreta
        self.total_cities[17] = Label(self.make_canvas, text="Dobreta", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[17].place(x=370, y=510)

        # LEVEL 5

        self.total_circle[18] = self.make_canvas.create_oval(440, 80, 510, 120, width=3)  # Fagaras -> Bucharest***
        self.total_cities[18] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[18].place(x=447, y=90)

        self.total_circle[19] = self.make_canvas.create_oval(440, 150, 510, 190, width=3)  # Rimnicu -> Craiova
        self.total_cities[19] = Label(self.make_canvas, text="Craiova", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[19].place(x=453, y=160)

        self.total_circle[20] = self.make_canvas.create_oval(440, 210, 510, 250, width=3)  # Rimnicu -> Pitesti
        self.total_cities[20] = Label(self.make_canvas, text="Pitesti", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[20].place(x=455, y=220)

        self.total_circle[21] = self.make_canvas.create_oval(440, 280, 510, 320, width=3)  # Pitesti -> Bucharest***
        self.total_cities[21] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[21].place(x=447, y=290)

        self.total_circle[22] = self.make_canvas.create_oval(440, 500, 510, 540, width=3)  # Dobreta -> Craiova
        self.total_cities[22] = Label(self.make_canvas, text="Craiova", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[22].place(x=450, y=510)

        # LEVEL 6

        self.total_circle[23] = self.make_canvas.create_oval(520, 150, 590, 190, width=3)  # Craiova -> Pitesti
        self.total_cities[23] = Label(self.make_canvas, text="Pitesti", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[23].place(x=535, y=160)

        self.total_circle[24] = self.make_canvas.create_oval(520, 210, 590, 250, width=3)  # Pitesti -> Bucharest***
        self.total_cities[24] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[24].place(x=527, y=220)

        self.total_circle[25] = self.make_canvas.create_oval(520, 440, 590, 480, width=3)  # Craiova -> Rimnicu
        self.total_cities[25] = Label(self.make_canvas, text="Rimnicu", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[25].place(x=530, y=450)

        self.total_circle[26] = self.make_canvas.create_oval(520, 500, 590, 540, width=3)  # Craiova -> Pitesti
        self.total_cities[26] = Label(self.make_canvas, text="Pitesti", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[26].place(x=535, y=510)

        # LEVEL 7

        self.total_circle[27] = self.make_canvas.create_oval(600, 150, 670, 190, width=3)  # Pitesti -> Bucharest***
        self.total_cities[27] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[27].place(x=607, y=160)

        self.total_circle[28] = self.make_canvas.create_oval(600, 440, 670, 480, width=3)  # Rimnicu -> Pitesti
        self.total_cities[28] = Label(self.make_canvas, text="Pitesti", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[28].place(x=615, y=450)

        self.total_circle[29] = self.make_canvas.create_oval(600, 500, 670, 540, width=3)  # Pitesti -> Bucharest***
        self.total_cities[29] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
        self.total_cities[29].place(x=607, y=510)

        # LEVEL 8

        self.total_circle[30] = self.make_canvas.create_oval(680, 440, 750, 480, width=3)  # Pitesti -> Bucharest***
        self.total_cities[30] = Label(self.make_canvas, text="Bucharest", bg="gray", fg="white", font=("Arial", 8, "italic"))
